...
public class Main extends javax.swing.JFrame {
    ...
    public void populate_db() throws SQLException, ClassNotFoundException {
        try{
             // Check if lodger table is empty
...
//            rs.close();
            ...
            if (lodgerCount == 0 && roomCount == 0 && regCount == 0) {
                ...
                // Insert data into lodger_tbl
                String insertLodger = "INSERT INTO lodger_tbl (lodgerNum,lodgerLastName,lodgerFirstName,lodgerCity,lodgerStreet,lodgerEmail,lodgerContactNum) VALUES (202401,'Corporal','Marc Lloyd','Mabalacat City','Amber Street','marccorporal23@gmail.com','09072248367'), (202402,'Dizon','Kirsten Dwayne','Mabalacat City','Oak Street','dizondwayne@gmail.com','09672345863'), (202403,'De Jesus','Kiana Beatriz','Angeles City','Liwayway Street','kbcd012002@yahoo.com','09623893863'), (202404,'Lusung','Mykel Robert','Angeles City','Gumamela Street','helloitsmykel@yahoo.com','09094632724'), (202405,'Garcia','Justin Clark','San Fernando City','Ubas Street','garciajustin@yahoo.com','09021292391'), (202406,'Reyes','Jade Theodore','San Fernando City','Iris Street','deartheodore@gmail.com','09235352425'), (202407,'Pineda','Mariella Lorin','Angeles City','Lakan Street','mariellalorin12@yahoo.com','09994324324')";
                PreparedStatement preparedStatementLodger = con.prepareStatement(insertLodger);
                // Set values for each record using preparedStatementLodger methods
                preparedStatementLodger.execute();

                // Insert data into room_tbl (similar logic as lodger_tbl)
                String insertRoom = "INSERT INTO room_tbl (roomNum,roomTier,roomPax,roomPrice) VALUES (201,'Standard',4,3000.00), (202,'Standard',4,3000.00), (203,'Standard',4,3000.00), (204,'Deluxe',6,4500.00), (205,'Deluxe',6,4500.00), (206,'Deluxe',6,4500.00), (207,'Executive',10,8000.00), (208,'Executive',10,8000.00), (209,'Presidential',15,12000.00), (210,'Presidential',15,12000.00)";
                PreparedStatement preparedStatementRoom = con.prepareStatement(insertRoom);
                preparedStatementRoom.execute();

                // Insert data into reg_tbl (similar logic as lodger_tbl and room_tbl)
                String insertReg = "INSERT INTO reg_tbl (regID,days,checkIn,checkOut,totalAmount,mop,lodgerNum,roomNum) VALUES(990960660,2,'2024-01-10','2024-01-12',9000.00,'Cash',202401,204),(990960324,3,'2024-01-16','2024-01-19',9000.00,'Cash',202401,201),(990960245,5,'2024-01-20','2024-01-25',22500.00,'Credit Card',202401,205),(990960567,4,'2024-01-24','2024-01-28',48000.00,'Credit Card',202402,210),(990960998,2,'2024-01-20','2024-01-22',9000.00,'Online',202402,205),(990960441,1,'2024-01-20','2024-01-21',8000.00,'Credit Card',202403,208),(990960939,1,'2024-01-01','2024-01-02',12000.00,'Credit Card',202404,210),(990960886,2,'2024-01-29','2024-01-31',6000.00,'Cash',202404,201),(990934533,1,'2024-01-03','2024-01-04',3000.00,'Online',202405,202),(990962332,2,'2024-01-14','2024-01-16',6000.00,'Online',202405,202),(990932239,1,'2024-01-24','2024-01-25',4500.00,'Cash',202405,206),(990931234,2,'2024-01-06','2024-01-08',24000.00,'Credit Card',202405,209),(990932435,5,'2024-01-10','2024-01-15',15000.00,'Online',202406,203),(990945676,1,'2024-01-17','2024-01-18',8000.00,'Online',202406,207),(990966666,1,'2024-01-26','2024-01-27',8000.00,'Online',202406,208),(990969911,2,'2024-01-24','2024-01-26',24000.00,'Credit Card',202407,209)";
                PreparedStatement preparedStatementReg = con.prepareStatement(insertReg);
                // Set values for each record using preparedStatementReg methods
...
//          con.close();
    ...
    public void loadLodgerNum(){
        try {
            pst = con.prepareStatement("SELECT lodgerNum FROM lodger_tbl");
            rs = pst.executeQuery();
            lodgerNumDropdown.removeAllItems();
            
            while (rs.next()){
                lodgerNumDropdown.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void loadLodgerNum1(){
        try {
            pst = con.prepareStatement("SELECT lodgerNum FROM lodger_tbl");
            rs = pst.executeQuery();
            lodgerNumDropdown1.removeAllItems();
            
            while (rs.next()){
                lodgerNumDropdown1.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void loadRoomNum(){
        try {
            pst = con.prepareStatement("SELECT roomNum FROM room_tbl");
            rs = pst.executeQuery();
            roomNumDropdown.removeAllItems();
            
            while (rs.next()){
                roomNumDropdown.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void loadRoomNum1(){
        try {
            pst = con.prepareStatement("SELECT roomNum FROM room_tbl");
            rs = pst.executeQuery();
            roomNumDropdown1.removeAllItems();
            
            while (rs.next()){
                roomNumDropdown1.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void loadRegNum(){
        try {
            pst = con.prepareStatement("SELECT regID FROM reg_tbl");
            rs = pst.executeQuery();
            regIdDropdown.removeAllItems();
            
            while (rs.next()){
                regIdDropdown.addItem(rs.getString(1));
            }
        } catch (SQLException ex) {
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void fetchLodger(){
        try {
            pst = con.prepareStatement("SELECT * FROM lodger_tbl");
            rs = pst.executeQuery();
            ResultSetMetaData rss = rs.getMetaData();
            int q = rss.getColumnCount();
            
            DefaultTableModel df = (DefaultTableModel)lodgerTbl.getModel();
            ...
            while (rs.next()){
                ...
                for (int a = 1; a <= q; a++){
                    v2.add(rs.getString("lodgerNum"));
                    v2.add(rs.getString("lodgerLastName"));
                    v2.add(rs.getString("lodgerFirstName"));
                    v2.add(rs.getString("lodgerCity"));
                    v2.add(rs.getString("lodgerStreet"));
                    v2.add(rs.getString("lodgerEmail"));
                    v2.add(rs.getString("lodgerContactNum"));
//                    v2.add(rs.getString("lodgerMOP"));
                }
                df.addRow(v2);
            }
        } catch (SQLException ex) {
    ...
    private void fetchRoom(){
        try {
            pst = con.prepareStatement("SELECT * FROM room_tbl");
            rs = pst.executeQuery();
            ResultSetMetaData rss = rs.getMetaData();
            int q = rss.getColumnCount();
            
            DefaultTableModel df = (DefaultTableModel)roomTbl.getModel();
            ...
            while (rs.next()){
                Vector v2 = new Vector();
                for (int a = 1; a <= q; a++){
                    v2.add(rs.getInt("roomNum"));
                    v2.add(rs.getString("roomTier"));
                    v2.add(rs.getInt("roomPax"));
                    v2.add(rs.getDouble("roomPrice"));
                }
                df.addRow(v2);
            }
        } catch (SQLException ex) {
    ...
    private void fetchReg(){
        try {
            pst = con.prepareStatement("SELECT * FROM reg_tbl");
            rs = pst.executeQuery();
            ResultSetMetaData rss = rs.getMetaData();
            int q = rss.getColumnCount();
            
            DefaultTableModel df = (DefaultTableModel)regTbl.getModel();
    ...
    //            pst = con.prepareStatement("SELECT lodgerMOP FROM lodger_tbl WHERE lodgerNum=?");
    //            pst.setInt(1, lodgerNum);
    //            
    //            rs = pst.executeQuery();
    //            
    //            while (rs.next()){
    //                mop = rs.getString("lodgerMOP");
    //            }
...
//                mopDropdown.setSelectedItem(rs.getString(8));
    ...
    private void srchRegBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_srchRegBtnActionPerformed
        ...
        try {
            ...
            if (rs.next() == true){
                regIDTxtFld.setText(rs.getString(1));
...
//                pst = con.prepareStatement("SELECT mop FROM reg_tbl WHERE regID=?");
//                pst.setInt(1, regNum);
//
//                rs = pst.executeQuery();
//
